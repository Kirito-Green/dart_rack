...
/**
  ...
  * @retval         none
  */
extern void cascade_PID_init(cascade_pid_t *c_pid, 
...
/**
  ...
  * @retval         pid输出
  */
fp32 PID_calc_ADRC(pid_type_def *pid, fp32 speed_rpm, fp32 torque, fp32 set, fp32 val_range);
extern fp32 PID_calc(pid_type_def *pid, fp32 ref, fp32 set, fp32 val_range);
...
/**
  ...
  * @retval         差分pid输出
  */
extern fp32 cascade_PID_calc(cascade_pid_t *c_pid, fp32 o_ref, fp32 i_ref, fp32 o_set, fp32 o_range, fp32 i_range);
...
extern fp32 ChooseShortestPath(fp32 set, fp32 ref, fp32 val_range);
