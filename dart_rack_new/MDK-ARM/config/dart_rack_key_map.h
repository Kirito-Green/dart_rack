...
#define SHOOT_CMD_TEST_ADJUST_KEYMAP (remote_channel_leftY())
//* 云台控制
// yaw
#define GIMBAL_CMD_YAW_COARSE_KEYMAP int_normalized_limit(handle_gimbal_right() - handle_gimbal_left() + cheak_key_press(KEY_PRESSED_OFFSET_V) - cheak_key_press(KEY_PRESSED_OFFSET_C))
#define GIMBAL_CMD_YAW_SLIGHT_KEYMAP fp32_normalized_limit(ANGLE_CONTROL_SENSE *(handle_chassis_left() - handle_chassis_right() + cheak_key_press(KEY_PRESSED_OFFSET_Z) - cheak_key_press(KEY_PRESSED_OFFSET_X)))
// pitch
#define GIMBAL_CMD_PITCH_SLIGHT_KEYMAP fp32_normalized_limit(REMOTE_CONTROL_SENSE *(handle_chassis_up() - handle_chassis_down()))
//* 发射指令
#define SHOOT_CMD_MATCH_LOAD_KEYMAP   int_normalized_limit(handle_chassis_up())
#define SHOOT_CMD_MATCH_LAUNCH_KEYMAP int_normalized_limit(handle_chassis_down())
